...
from harl.algorithms.actors.on_policy_base_mod import OnPolicyBaseMod

class HAPPOMod(OnPolicyBaseMod):
    def __init__(self, args, obs_space, act_space, device=torch.device("cpu")):
        """Initialize HAPPOMod algorithm. Same as HAPPO but allows the injection of an mlp 
        before the actor for higher level learning.
        Args:
            args: (dict) arguments.
        ...
        """
        super(HAPPOMod, self).__init__(args, obs_space, act_space, device)
